export default function Header() {
    return (
        <header className="flex max-w-full px-4 z-20 py-6 justify-between items-center sticky top-0 bg-violet-200 border-b-1 border-gray-300 shadow-lg">
            <div className="flex space-x-4">
                <h1 className="text-3xl font-bold text-violet-500">API FLOW</h1>
                <form action="">
                    <input type="text" placeholder="Name of journey" className="px-3 py-2 my-auto border-2 border-gray-300" /> 
                </form>
            </div>
            <div className="flex space-x-4">
